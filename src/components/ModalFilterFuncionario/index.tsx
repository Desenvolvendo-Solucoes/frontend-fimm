...
const ModalFilterFuncionario: React.FC<IModal> = ({ isOpen, setOpen }) => {
  // if (isOpen) {
  return (
    <div
    ...
    >
      ...
      >
        ...
        <div className="overflow-hidden overflow-y-scroll">
          ...
          <label className="p-2 text-gray-400  ">Filtre pelo CPF</label>
          <input
            className="mb-4 w-full rounded-md border border-gray-300 p-3"
            type="text"
          ...
          <label className="p-2 text-gray-400  ">Filtre pela Função</label>
          <input
            className="mb-4 w-full rounded-md border border-gray-300 p-3"
            type="text"
          ...
          <hr className="mb-4"></hr>
          <h2 className="p-2 font-bold">Base</h2>
          <label className="p-2 text-gray-400  ">Filtre pelo Base</label>
          <input
            className="mb-4 w-full rounded-md border border-gray-300 p-3"
            type="text"
            placeholder="Ex: Cajati"
          />

          <hr className="mb-4"></hr>
          <h2 className="p-2 font-bold">Cidade</h2>
          <label className="p-2 text-gray-400  ">Filtre pela Cidade</label>
          <input
            className="mb-4 w-full rounded-md border border-gray-300 p-3"
            type="text"
          ...
          <label className="p-2 text-gray-400  ">Filtre pelo E-mail</label>
          <input
            className="mb-4 w-full rounded-md border border-gray-300 p-3"
            type="text"
...
export default ModalFilterFuncionario
